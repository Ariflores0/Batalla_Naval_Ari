...
<body>
    <div class="container">
        ...
        <div id="div-texto-barcos">
            ...
            <p id="texto-barcos">1. Presiona las casillas en las que deseas colocar tus barcos.<br>2. Tienes 4 barcos para posicionar, elige el lugar de tu barco.</p>
        </div>
        <div id="btn-aceptar">
